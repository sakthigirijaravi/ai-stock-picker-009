...
const MomentumPortfolio: React.FC = () => {
  ...
  const displayData = user ? portfolioData : portfolioData.slice(0, 3);
  const isLimitedView = !user && portfolioData.length > 3;
            ...
            <div className="p-6 bg-gradient-to-r from-orange-50 to-red-50 border-t border-orange-200">
              <div className="text-center">
                ...
                <p className="text-orange-700 mb-4">
                  Sign in to view all {portfolioData.length} stocks in the momentum portfolio with detailed analytics
                </p>
